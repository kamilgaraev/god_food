...
## Header and mobile polish — финальный проход

- Desktop header проверен на 1101, 1200, 1440 и 2295 px: центр логотипа совпадает с центром viewport с отклонением 0 px; максимальное отклонение контролов от общей вертикальной оси — 0,5 px; пересечений меню с логотипом нет.
- Mobile header проверен на 320, 390, 440 и 768 px: иконка «Личного кабинета» видна рядом с корзиной, высота корзины стабильна на 38 px, account/cart/burger находятся на общей оси с отклонением не более 0,5 px.
- Mobile hero уменьшен до 420–450 px и переведён на последовательную grid-композицию. Текст, trust и обе CTA полностью видны; benefit strip следует сразу за hero.
- Горизонтальный overflow равен 0 на всех восьми контрольных ширинах.
- Визуальные доказательства: `output/playwright/header-polish/header-hero-{1440x900,1101x900,768x1024,440x956,390x844,320x720}.png`.
- Пройдены responsive header, homepage visual/contract/tablet, commerce flow, keyboard navigation, PHP lint и accessibility 104/104. Открытых P0/P1/P2 замечаний нет.
