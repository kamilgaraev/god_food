...
**Goal:** Add production-grade WooCommerce delivery integration boundaries, fully implement CDEK API v2 without credentials, and prepare a fail-closed Ozon Logistics merchant adapter that can be activated when Ozon issues the contract package.
...
### Task 5: Ozon Logistics activation boundary

**Files:**
- Create: `wp-content/plugins/theobroma-commerce/src/Integrations/Ozon/OzonCapabilities.php`
- Create: `wp-content/plugins/theobroma-commerce/src/Integrations/Ozon/OzonMerchantAdapter.php`
- Test: `wp-content/plugins/theobroma-commerce/tests/OzonCapabilitiesTest.php`

Test that Ozon remains unavailable without a complete merchant contract and never invents rates. Support configuration of contract-issued base URL, auth scheme, widget/script URL, callback secret and mode without exposing secrets frontend-side.
