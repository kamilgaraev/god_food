...
foreach (array('theobroma_standard_contact_request_is_valid', 'theobroma_standard_contact_request_recipient', 'theobroma_standard_contact_request_lines') as $function) {
