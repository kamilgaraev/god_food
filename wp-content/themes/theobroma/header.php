...
<aside class="floating-actions" aria-label="Быстрые действия">
    ...
    <a href="#wishlist" data-wishlist-open aria-label="Избранное"><img src="<?php echo esc_url(get_stylesheet_directory_uri() . '/assets/images/heart.svg'); ?>" alt=""><span class="wishlist-count">(<?php echo esc_html((string) count((array) apply_filters('theobroma_wishlist_ids', array()))); ?>)</span></a>
    <a href="<?php echo esc_url(function_exists('wc_get_page_permalink') ? wc_get_page_permalink('myaccount') : wp_login_url()); ?>"<?php echo !is_user_logged_in() ? ' data-account-trigger' : ''; ?> aria-label="Личный кабинет"><img src="<?php echo esc_url(get_stylesheet_directory_uri() . '/assets/images/user.webp'); ?>" alt=""><span>ЛК</span></a>
</aside>
