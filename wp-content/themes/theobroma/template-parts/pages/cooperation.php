<main class="cooperation-page">
    ...
    <section class="cooperation-form" aria-labelledby="cooperation-form-title">
        ...
        <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
            ...
            <div class="form-grid"><input type="text" name="name" placeholder="Имя" aria-label="Имя" required><div class="phone-field"><input type="tel" name="phone" value="+7" placeholder="+7 (000) 000-00-00" inputmode="tel" autocomplete="tel" maxlength="18" aria-label="Телефон" required></div></div>
