<footer class="site-footer" id="contacts">
    <div class="footer-shell">
        ...
        <?php $footer_phone_1 = theobroma_content('footer_phone_1'); $footer_phone_2 = theobroma_content('footer_phone_2'); ?>
        <div class="footer-phones"><span><?php echo esc_html($footer_phone_1); ?></span><span><?php echo esc_html($footer_phone_2); ?></span></div>
        ...
        <div class="footer-card footer-mail"><strong><?php echo esc_html(theobroma_content('footer_info_email')); ?></strong><small><?php echo nl2br(esc_html(theobroma_content('footer_info_note'))); ?></small></div>
        <div class="footer-card footer-mail"><strong><?php echo esc_html(theobroma_content('footer_opt_email')); ?></strong><small><?php echo nl2br(esc_html(theobroma_content('footer_opt_note'))); ?></small></div>
        <div class="footer-card footer-mail"><strong><?php echo esc_html(theobroma_content('footer_press_email')); ?></strong><small><?php echo nl2br(esc_html(theobroma_content('footer_press_note'))); ?></small></div>
    </div>
